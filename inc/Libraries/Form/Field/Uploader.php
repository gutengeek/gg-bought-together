 ...
 * @version    $Id$
 * @package    gg_woo_bt
 * @author     Opal  Team <info@gg_woo_bt.com >
 * @copyright  Copyright (C) 2019 gg_woo_bt.com. All Rights Reserved.
 * @license    GNU/GPL v2 or later http://www.gnu.org/licenses/gpl-2.0.html
 *
 * @website  http://www.gg_woo_bt.com
 * @support  http://www.gg_woo_bt.com/support/forum.html
 */
...
class Uploader {
	...
	public function render() {
		...
		$this->form->add_dependencies( 'gg_woo_bt-uploader-js' );
		...
		if ( isset( $args['accept'] ) && $args['accept'] ) {
			...
			$info = [
				'size'   => gg_woo_bt_get_option( 'upload_other_max_size', 0.5 ),
				'number' => gg_woo_bt_get_option( 'upload_other_max_files', 10 ),
			];
			...
			$info = [
				'size'   => gg_woo_bt_get_option( 'upload_image_max_size', 0.5 ),
				'number' => gg_woo_bt_get_option( 'upload_image_max_files', 10 ),
			];
		}
		if ( $single ) {
			$info['number'] = 1;
		...
		?>
        <div class="gg_woo_bt-uploader-files <?php echo $class; ?>" data-name="<?php echo $args['id']; ?>" data-single="<?php echo $single; ?>" data-show-icon="<?php echo $show_icon; ?>">
            ...
            <div class="button-placehold">
                <div class="button-placehold-content">
                    ...
                    <span><?php _e( "Upload", "gg_woo_bt" ); ?></span>
                </div>
            </div>
        ...
        <p class="gg_woo_bt-metabox-description">
            <i>
				<?php
				echo sprintf( __( 'Allow upload file have size < %s MB and maximum number of files: %s', 'gg-woo-bt' ),
