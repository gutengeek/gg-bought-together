...
$defaults = [
	...
	'name'        => '',
	'description' => null,
	'class'       => 'gg_woo_bt-checkbox form-control',
	'data'        => [],
	'default'	  => '',
	'disabled'    => false,
];
...
$output = '<div class="gg_woo_bt-field-wrap gg_woo_bt-checkbox-field-wrap form-group" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';
if( $this->show_label ) {
