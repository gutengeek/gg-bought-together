...
$defaults = [
	...
	'name'        => '',
	'description' => null,
	'class'       => 'gg_woo_bt-switch form-control',
	'wrap_class'  => '',
	'data'        => [],
	'disabled'    => false,
	'default'     => '',
...
$output .= '<div class="gg_woo_bt-field-wrap gg_woo_bt-switch-field-wrap form-group ' . $wrap_class . '" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';

if ( $args['name'] ) {
	$output .= '<label class="gg_woo_bt-label" for="' . sanitize_key( $this->form_id . $args['id'] ) . '">' . esc_html( $args['name'] ) . '</label>';
}
$output .= '<div class="gg_woo_bt-field-main">';
$output .= '<label class="gg_woo_bt-switch-input">';
