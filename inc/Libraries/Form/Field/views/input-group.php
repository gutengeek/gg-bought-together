...
?>
<div class="gg_woo_bt-group-field-wrap gg_woo_bt-repeatable-field-section <?php echo esc_attr( $wrapper_class ); ?>" data-field="<?php echo "{$args['id']}"; ?>" id="<?php echo "{$args['id']}_field"; ?>"
	...
	<?php if ( ! empty( $args['name'] ) ) : ?>
        <p class="gg_woo_bt-repeater-field-name"><?php echo trim( $args['name'] ); ?></p>
	<?php endif; ?>

	<?php if ( ! empty( $args['description'] ) ) : ?>
        <p class="gg_woo_bt-repeater-field-description"><?php echo esc_html( $args['description'] ); ?></p>
	<?php endif; ?>

    <table class="gg_woo_bt-repeatable-fields-section-wrapper" cellspacing="0">
		<?php
		$repeater_field_values = $this->get_field_value( $args );

		$header_title = isset( $args['options']['header_title'] )
			? $args['options']['header_title']
			: esc_attr__( 'Group', 'gg-woo-bt' );
        ...
        <tr class="gg_woo_bt-template">
            <td class="gg_woo_bt-repeater-field-wrap gg_woo_bt-column" colspan="2">
                <div class="opal-row-head gg_woo_bt-move">
                    ...
                    <div class="button-action-group">
                    	<span class="gg_woo_bt-remove button-action" title="<?php esc_attr_e( 'Remove Group', 'gg-woo-bt' ); ?>">
        ...
        <tr>
			...
			$add_row_btn_title = isset( $args['options']['add_button'] )
				...
				: esc_html__( 'Add Row', 'gg-woo-bt' );
			?>
            <td colspan="2" class="gg_woo_bt-add-repeater-field-section-row-wrap">
