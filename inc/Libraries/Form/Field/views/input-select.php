...
$defaults = [
	...
	'options'          => [],
	'description'      => null,
	'class'            => 'gg_woo_bt-select form-control',
	'wrap_class'       => '',
	'autocomplete'     => 'off',
	'selected'         => 0,
	'chosen'           => false,
...
$output .= '<div class="gg_woo_bt-field-wrap gg_woo_bt-select-field-wrap form-group '. esc_attr( $wrap_class ) .'" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap" >';
if ( $this->show_label ) {
