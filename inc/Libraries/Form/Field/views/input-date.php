...
$defaults = [
	...
	'description'     => null,
	'placeholder'     => '',
	'class'           => 'gg_woo_bt-datepicker regular-text form-control',
	'data'            => false,
	'disabled'        => false,
	'date_format'     => '',
	'date_storage'    => '',
...
$output = '<div class="gg_woo_bt-field-wrap gg_woo_bt-date-field-wrap form-group" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';
if ( $args['show_label'] ) {
