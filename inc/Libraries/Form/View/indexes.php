...
?>
    ...
    <div class="js-gg_woo_bt-metabox-wrap metabox-panel-wrap">
        <div class="gg_woo_bt-tab gg_woo_bt-tab-verticle">
            <ul class="gg_woo_bt-form-data-inline-tabs gg_woo_bt-metabox-inline-tabs gg_woo_bt-tab-head">
                        ...
                        <a href="#<?php echo $form_data_tab['id']; ?>"
                           data-tab-id="<?php echo $form_data_tab['id']; ?>">
                            ...
                            <?php else : ?>
                                <span class="gg_woo_bt-icon gg_woo_bt-icon-default"></span>
                            <?php endif; ?>
                            <span class="gg_woo_bt-label"><?php echo $setting['title']; ?></span>
                        </a>
                     </div>
                ...
                <?php if ( $this->has_sub_tab( $setting ) ) : ?>
                    <?php if ( ! empty( $setting['sub-fields'] ) ) : ?>
                        <?php foreach ( $setting['sub-fields'] as $index => $sub_fields ) : ?>
                            <div id="<?php echo $sub_fields['id']; ?>" class="panel gg_woo_bt_options_panel gg_woo_bt-hidden gg_woo_bt-panel">
