...
gulp.task('admin-minify:css', () => {
    return gulp.src(['assets/css/admin/*.css', '!assets/css/*.min.scss'])
               .pipe(debug())
               .pipe(plumber(handleErrors))
               .pipe(cleanCSS())
               .pipe(rename({ suffix: '.min' }))
...
gulp.task('minify:css', () => {
    return gulp.src(['assets/css/*.css', '!assets/css/*.min.scss'])
               .pipe(debug())
               .pipe(plumber(handleErrors))
               .pipe(cleanCSS())
               .pipe(rename({ suffix: '.min' }))
...
gulp.task('i18n', () => {
    return gulp.src(['*.php', 'inc/**/*.php', 'inc/**/**/*.php', '!vendor/**', '!tests/**'])
               .pipe(plumber(handleErrors))
               .pipe(potgen({ domain: pkg.name, package: 'gg-woo-bt' }))
...
gulp.task('js', gulp.series(['babel', 'babel-admin', 'minify:js', 'admin-minify:js']))
gulp.task('css', gulp.series(['scss', 'admin-scss', 'minify:css', 'admin-minify:css']))
